...
public class addNote extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
       ...
       void save_data(boolean opeartionTYpe){
          ...
          if (opeartionTYpe)
          {
              ...
              noteviewModel.getlastRow().observe(this, new Observer<List<Integer>>() {
                  @Override
                  public void onChanged(List<Integer> integers) {
                      note.setID(integers.get(0));
    ...
    public void onClick(View view) {
       ...
       String sdesc =desc.getText().toString();
        if (stitle.isEmpty()|| sdesc.isEmpty())
        {
            ...
            if (add_operation)
            {
                //if in add mode save note first in database before can add any of note feature such as notifaction , remider
                save_data(add_operation);
                add_operation =false;
            }
            else
            {
                                                      ...
                                                      public void onCheckedChanged(CompoundButton compoundButton, boolean checked) {
                                                          ...
                                                          else
                                                          {
                                                           ...
                                                           txt_reminder.setVisibility(View.GONE);
                                                              ...
                                                              Toast.makeText(addNote.this, "alarm cancled", Toast.LENGTH_SHORT).show();
                                                          }
                                                      }
                                                  }
         );
     ...
     public void notif(int notified) {
        ...
        if (notified == 0) {
            ...
            notif.setStyle(new NotificationCompat.BigTextStyle().bigText(note.getDescription())
                    .setSummaryText("bakro"));
            // Sets an ID for the notification
             Intent resultIntent = new Intent(this, addNote.class);
    ...
    public void setupAlarm(){
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(
                addNote.this,R.style.TimePickerTheme,
                new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker datePicker, final int year, final int month, final int day) {
                        if (noOfTimesCalledDate % 2 == 0) {
                            new TimePickerDialog(addNote.this,R.style.TimePickerTheme,
                                        ...
                                        public void onTimeSet(TimePicker timePicker, int hour, int min) {
                                            if (noOfTimesCalledTime % 2 == 0) {
                                                ...
                                                if (calendar.compareTo(Calendar.getInstance()) <= 0) {
                                                    Toast.makeText(addNote.this, "past time", Toast.LENGTH_SHORT).show();
                                                    return;
                                                }
        ...
        addarchiveSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
              if (isChecked)
              {
                  ...
                  noteviewModel.update(note);
                  Toast.makeText(addNote.this, "add to archive", Toast.LENGTH_SHORT).show();
              }
              else
              {
        ...
        addfavouirtSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked)
                {
                    ...
                    Toast.makeText(addNote.this, "added to favouirt", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    note.setFavourite(false);
                    Toast.makeText(addNote.this, "Removed from favouirt", Toast.LENGTH_SHORT).show();
                }
                noteviewModel.update(note);
    ...
    public void delete(View view) {
         ...
         else
         {
             ...
             note.setFavourite(false);
             noteviewModel.update(note);
             Toast.makeText(addNote.this, "Moved to Trash", Toast.LENGTH_SHORT).show();
         }
    ...
    public void pickColor(View view) {
        ColorPickerListener listener=new ColorPickerListener() {
          ...
          noteviewModel.update(note);
          Log.e("bakrbekooo", "color updated");
            }
